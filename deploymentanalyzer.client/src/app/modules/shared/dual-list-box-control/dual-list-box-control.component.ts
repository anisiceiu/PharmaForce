...
@Component({
  selector: 'dual-list-box-control',
  templateUrl: './dual-list-box-control.component.html',
  styleUrl: './dual-list-box-control.component.css'
})
export class DualListBoxControlComponent {
  ...
  static DEFAULT_FORMAT = { add: 'Add', remove: 'Remove', all: 'All', none: 'None', direction: DualListBoxControlComponent.LTR, draggable: true };
  ...
  @Input() height = '100px';
  @Input() filter = false;
  @Input() format = DualListBoxControlComponent.DEFAULT_FORMAT;
  @Input() sort = false;
  ...
  constructor(private differs: IterableDiffers) {
    this.available = new BasicList(DualListBoxControlComponent.AVAILABLE_LIST_NAME);
    this.confirmed = new BasicList(DualListBoxControlComponent.CONFIRMED_LIST_NAME);
  }
  ...
  ngOnChanges(changeRecord: { [key: string]: SimpleChange }) {
    ...
    if (changeRecord['format']) {
      ...
      if (typeof (this.format.direction) === 'undefined') {
        this.format.direction = DualListBoxControlComponent.LTR;
      }

      if (typeof (this.format.add) === 'undefined') {
        this.format.add = DualListBoxControlComponent.DEFAULT_FORMAT.add;
      }

      if (typeof (this.format.remove) === 'undefined') {
        this.format.remove = DualListBoxControlComponent.DEFAULT_FORMAT.remove;
      }

      if (typeof (this.format.all) === 'undefined') {
        this.format.all = DualListBoxControlComponent.DEFAULT_FORMAT.all;
      }

      if (typeof (this.format.none) === 'undefined') {
        this.format.none = DualListBoxControlComponent.DEFAULT_FORMAT.none;
      }

      if (typeof (this.format.draggable) === 'undefined') {
        this.format.draggable = DualListBoxControlComponent.DEFAULT_FORMAT.draggable;
      }
    }
  ...
  direction() {
    return this.format.direction === DualListBoxControlComponent.LTR;
  }
