...
import { AddSalesforceTypeMasterCodeComponent } from '../../shared/master-code/add-salesforce-type-master-code/add-salesforce-type-master-code.component';
...
@Component({
  selector: 'app-salesforce-type-master-code',
  templateUrl: './salesforce-type-master-code.component.html',
  styleUrl: './salesforce-type-master-code.component.css'
})
export class SalesforceTypeMasterCodeComponent {

  mastercodes: MasterCode[] = [];
  currentUser: any;
  masterCodeCategory: string = 'SalesForce_Type';
  ...
  openDialog(mastercode?: MasterCode): void {
    ...
    const dialogRef = this.dialog.open(AddSalesforceTypeMasterCodeComponent, {
      width: '400px',
      data: {
