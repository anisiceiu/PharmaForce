...
import { GetBrandGroupFilters, GetCustomerDropdowns, GetRegionListHavingCountry, GetSalesforceList, addUserPreference, getAdminPeriods, getAdminTherapeuticCategories, getCallPlanningFilters, getCallPlanningRecords, getUserPreferences } from '../../../constants/api.constant';
import { UserPreference } from '../../../models/userPreference';
import { ApiResponse } from '../../../models/ApiResponse';
import { CallPlanning } from '../../../models/callpanning';
...
@Component({
  selector: 'app-call-planning',
  templateUrl: './call-planning.component.html',
  styleUrl: './call-planning.component.css'
})
export class CallPlanningComponent implements OnInit {
  ...
  dataItems: CallPlanning[] = [];
  showFilter = false;
  searchForm: FormGroup;
  sortField = '';
  sortDirection = '';
  exportExcelFileName: string = "Call Planning Grid Data.xlsx";

  @ViewChild(MatPaginator, { static: false }) paginator!: MatPaginator;
  @ViewChild(MatSort) sort!: MatSort;
  accordion = viewChild.required(MatAccordion);

  dataSource = new MatTableDataSource<CallPlanning>(this.dataItems);
  ...
  exportToexcel(): void {
    ...
    let element = document.getElementById('tblCallPlanning');
  ...
  resetAllFilters() {
    ...
    this.searchForm.controls['therapticCategoryAuto'].setValue(null);
  ...
  fetchData(): Observable<any> {
    ...
    return this.apiService.PostAll(getCallPlanningRecords, data);
  }
  ...
  initializeDataSource() {
    merge(this.paginator.page)
      .pipe(
        ...
        map((data) => {
          this.dataItems = this.manipulateCallPlanningGridData(data.result.records);
          this.totalRecords = data.result.totalRecords;
          this.dataSource = new MatTableDataSource<CallPlanning>(
            this.dataItems
          );
  ...
  manipulateCallPlanningGridData(arr: CallPlanning[]) {
    let helper: any = {};
